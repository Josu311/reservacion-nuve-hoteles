<template>
    <header class="fixed top-0 left-0 w-full flex flex-col justify-center bg-white z-[997] shadow-md">
        <div class="hidden md:block w-full bg-nuve-parras-beige py-3">
            <div class="max-w-6xl mx-auto flex flex-col-reverse md:flex-row justify-between items-center text-gray-800">
        ...
        <div class="w-full flex items-center">
            <div class="w-full max-w-6xl mx-auto flex justify-between items-center py-2 px-6 lg:px-0">
                <a href="/">
                    <img class="h-14" src="/img/parras/hotel-parras-logo.webp" alt="Logo de Nuve Hotel">
                </a>
                        ...
                        <li class="flex items-center gap-2 text-lg" v-if="true">
                            <div>
                                ...
                                <a v-else :href="route('login')" class="">
                                    <p
                                        class="flex items-center gap-1 text-sm text-gray-800 font-semibold uppercase bg-nuve-parras-beige rounded-md ml-3 p-3 hover:underline">
                                        Iniciar sesión
