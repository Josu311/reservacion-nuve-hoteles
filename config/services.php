...
return [
    ...
    */
    ...
    'fc' => [
        ...
        'soap_timeout'  => env('FC_SOAP_TIMEOUT', 60),
        'availability_soap_timeout' => env('FC_AVAILABILITY_SOAP_TIMEOUT', 10),
        'availability_request_time_limit' => env('FC_AVAILABILITY_REQUEST_TIME_LIMIT', 90),
    ...
    'hotels' => [
        'torreon' => [
            ...
            'fc' => [
                ...
                'soap_timeout' => env('FC_TORREON_SOAP_TIMEOUT', env('FC_SOAP_TIMEOUT', 60)),
                'availability_soap_timeout' => env('FC_TORREON_AVAILABILITY_SOAP_TIMEOUT', env('FC_AVAILABILITY_SOAP_TIMEOUT', 10)),
                'availability_request_time_limit' => env('FC_TORREON_AVAILABILITY_REQUEST_TIME_LIMIT', env('FC_AVAILABILITY_REQUEST_TIME_LIMIT', 90)),
        ...
        'gomez' => [
            ...
            'fc' => [
                ...
                'soap_timeout' => env('FC_GOMEZ_SOAP_TIMEOUT', env('FC_SOAP_TIMEOUT', 60)),
                'availability_soap_timeout' => env('FC_GOMEZ_AVAILABILITY_SOAP_TIMEOUT', env('FC_AVAILABILITY_SOAP_TIMEOUT', 10)),
                'availability_request_time_limit' => env('FC_GOMEZ_AVAILABILITY_REQUEST_TIME_LIMIT', env('FC_AVAILABILITY_REQUEST_TIME_LIMIT', 90)),
        ...
        'parras' => [
            ...
            'fc' => [
                ...
                'soap_debug' => env('FC_SOAP_DEBUG', false),
                'soap_timeout' => env('FC_PARRAS_SOAP_TIMEOUT', env('FC_SOAP_TIMEOUT', 60)),
                'availability_soap_timeout' => env('FC_PARRAS_AVAILABILITY_SOAP_TIMEOUT', env('FC_AVAILABILITY_SOAP_TIMEOUT', 60)),
                'availability_request_time_limit' => env('FC_PARRAS_AVAILABILITY_REQUEST_TIME_LIMIT', env('FC_AVAILABILITY_REQUEST_TIME_LIMIT', 90)),
                'hold_ttl_minutes' => env('FC_HOLD_TTL_MINUTES', 30),
                'dummy_cc' => env('FC_DUMMY_CC', '0000000000000000'),
            ],
            'stripe' => [
